...
in {
  options.programs.plasma.umbrellorc = {
    ...
    "CPP Code Generation" = with types;
      mkOption {
        type = submodule {
          options = {
        ...
        type = submodule {
          options = {
            ...
            "showStereoType" = mkOption {
              type = nullOr (either str (enum [ "None" "Name" "Tags" ]));
        ...
        type = submodule {
          options = {
            ...
            "commentStyle" = mkOption {
              type = nullOr (either str (enum [ "SingleLine" "MultiLine" ]));
            ...
            "indentationType" = mkOption {
              type = nullOr (either str (enum [ "NONE" "TAB" "SPACE" ]));
            ...
            "lineEndingType" = mkOption {
              type = nullOr (either str (enum [ "UNIX" "DOS" "MAC" ]));
            ...
            "modnamePolicy" = mkOption {
              type =
                nullOr (either str (enum [ "No" "Underscore" "Capitalise" ]));
            ...
            "overwritePolicy" = mkOption {
              type = nullOr (either str (enum [ "Ok" "Ask" "Never" "Cancel" ]));
    ...
    "Code Viewer Options" = with types;
      mkOption {
        type = submodule {
          options = {
    ...
    "Java Code Generation" = with types;
      mkOption {
        type = submodule {
          options = {
            "autoGenerateAssocAccessors" = mkOption {
    ...
    "Ruby Code Generation" = with types;
      mkOption {
        type = submodule {
          options = {
            "autoGenerateAssocAccessors" = mkOption {
  ...
  config =
    mkIf cfg.enable { programs.plasma.files."umbrellorc" = cfg.umbrellorc; };
}
