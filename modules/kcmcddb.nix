...
in {
        ...
        type = submodule {
          options = {
            ...
            "FreedbLookupTransport" = mkOption {
              type = nullOr (either str (enum [ "CDDBP" "HTTP" ]));
              default = "HTTP";
              description = ''
            ...
            "cacheLocations" = mkOption {
              ...
              default =
                ''QStringList(QDir::homePath()+QLatin1String("/.cddb/"))'';
        ...
        type = submodule {
          options = {
            "FreedbSubmitTransport" = mkOption {
              type = nullOr (either str (enum [ "HTTP" "SMTP" ]));
              default = "HTTP";
              description = ''
  ...
  config = mkIf cfg.enable { programs.plasma.files."kcmcddbrc" = cfg.kcmcddb; };
}
