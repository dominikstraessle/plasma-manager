...
in {
        ...
        type = submodule {
          options = {
            ...
            "MouseBlacklist" = mkOption {
              ...
              default =
                "TPPS/2 IBM TrackPoint,USB Trackpoint pointing device,DualPoint Stick,ThinkPad USB Keyboard with TrackPoint";
              description = ''
  ...
  config =
    mkIf cfg.enable { programs.plasma.files."touchpadrc" = cfg.touchpad; };
}
