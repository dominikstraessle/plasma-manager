...
in {
  options.programs.plasma.kspread = {
    ...
    "KSpread Page Layout" = with types;
      mkOption {
        type = submodule {
          options = {
  ...
  config = mkIf cfg.enable { programs.plasma.files."kspreadrc" = cfg.kspread; };
}
