      ...
      type = submodule {
        options = { 
          ...
          favoriteApps = mkOption {
            type = nullOr (either str (listOf str));
            default = "preferred://browser,org.kde.kontact.desktop,systemsettings.desktop,org.kde.dolphin.desktop,ktp-contactlist.desktop,org.kde.discover";
            description = ''
          ...
          favorites = mkOption {
            type = nullOr (either str (listOf str));
            default = "preferred://browser,org.kde.kontact.desktop,systemsettings.desktop,org.kde.dolphin.desktop,ktp-contactlist.desktop,org.kde.discover.desktop";
            description = ''
              List of general favorites. Supported values are menu id's (usually .desktop file names), special URLs that expand into default applications (e.g. preferred://browser), document URLs and KPeople contact URIs.
          ...
          launchers = mkOption {
            type = nullOr (either str (listOf str));
            default = "applications:systemsettings.desktop,applications:org.kde.discover.desktop,preferred://filemanager,preferred://browser";
            description = ''
          ...
          systemApplications = mkOption {
            type = nullOr (either str (listOf str));
            default = "systemsettings.desktop,org.kde.kinfocenter.desktop,org.kde.discover.desktop";
            description = ''
