...
in {
        ...
        type = submodule {
          options = {
            ...
            "Destination" = mkOption {
              type = nullOr
                (either str (enum [ "standardDestination" "askDestination" ]));
  ...
  config =
    mkIf cfg.enable { programs.plasma.files."korganizerrc" = cfg.korganizer; };
}
