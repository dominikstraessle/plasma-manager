...
in {
  options.programs.plasma.kalarm = {
      ...
      mkOption {
        type = submodule {
          options = {
            ...
            "CmdLogType" = mkOption {
              type = nullOr (either str (enum [ "Discard" "File" "Terminal" ]));
              default = "Discard";
              description = ''
                Command output
            ...
            "DisplayMethod" = mkOption {
              type = nullOr (either str (enum [ "Window" "Notification" ]));
              default = "Window";
              description = ''
            ...
            "Feb29Recur" = mkOption {
              type = nullOr (either str (enum [ "Feb28" "Mar1" "None" ]));
              default = "Mar1";
              description = ''
            ...
            "RemindUnits" = mkOption {
              type = nullOr (either str (enum [ "Minutes" "HoursMinutes" ]));
            ...
            "SoundType" = mkOption {
              type =
                nullOr (either str (enum [ "None" "Beep" "File" "Speak" ]));
              default = "None";
              description = ''
                Sound
      ...
      mkOption {
        type = submodule {
          options = {
            ...
            "Backend" = mkOption {
              type = nullOr
                (either str (enum [ "Kresources" "Akonadi" "FileResources" ]));
              default = "";
              description = ''
            ...
            "DisabledColour" = mkOption {
              type = nullOr str;
              default =
                "KColorScheme(QPalette::Disabled).foreground(KColorScheme::InactiveText).color()";
            ...
            "EmailClient" = mkOption {
              type = nullOr (either str (enum [ "sendmail" "kmail" ]));
              default = "kmail";
              description = ''
                Email client
            ...
            "EmailFrom" = mkOption {
              type = nullOr str;
              default = ''
                KAlarmCal::Identities::identitiesExist() ? QLatin1String("@KMail") : QLatin1String("@SystemSettings")'';
              defaultText = "Code: true";
              description = ''
                'From' email address
            ...
            "ExpiredColour" = mkOption {
              type = nullOr str;
              default =
                "KColorScheme(QPalette::Active).foreground(KColorScheme::VisitedText).color()";
              defaultText = "Code: true";
              description = ''
            ...
            "MessageFont" = mkOption {
              type = nullOr str;
              default =
                "QFont(QFontDatabase::systemFont(QFontDatabase::GeneralFont).family(), 16, QFont::Bold)";
              defaultText = "Code: true";
              description = ''
                Message font
    ...
    "Notification Messages" = with types;
      mkOption {
        type = submodule {
          options = {
  ...
  config = mkIf cfg.enable { programs.plasma.files."kalarmrc" = cfg.kalarm; };
}
