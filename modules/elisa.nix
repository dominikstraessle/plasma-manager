...
in {
          ...
          options = {
            ...
            "EmbeddedView" = mkOption {
              type = nullOr (either str
                (enum [ "NoView" "AllAlbums" "AllArtists" "AllGenres" ]));
              default = "";
              description = ''
  ...
  config = mkIf cfg.enable { programs.plasma.files."elisarc" = cfg.elisa; };
}
