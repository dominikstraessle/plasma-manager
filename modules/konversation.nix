...
in {
  options.programs.plasma.konversation = {
    ...
    "External Log Viewer" = with types;
      mkOption {
        type = submodule {
          options = {
        ...
        type = submodule {
          options = {
            ...
            "TabPlacement" = mkOption {
              type = nullOr (either str (enum [ "Top" "Bottom" "Left" ]));
              default = "Left";
              description = ''
    ...
    "Message Text Colors" = with types;
      mkOption {
        type = submodule {
          options = {
            "$(colorName)" = mkOption {
        ...
        type = submodule {
          options = {
            ...
            "LogfilePath" = mkOption {
              type = nullOr str;
              default = ''
                QUrl::fromLocalFile(QStandardPaths::writableLocation(QStandardPaths::AppDataLocation)+QLatin1String("/logs"))'';
              defaultText = "Code: true";
              description = ''
      ...
      mkOption {
        type = submodule {
          options = {
            ...
            "ProxyType" = mkOption {
              type = nullOr (either str (enum [ "Socksv5Proxy" "HTTPProxy" ]));
    ...
    "Web Browser Settings" = with types;
      mkOption {
        type = submodule {
          options = {
