...
in {
        ...
        type = submodule {
          options = {
            ...
            "ThumbnailBarOrientation" = mkOption {
              type =
                nullOr (either str (enum [ "Dummy" "Horizontal" "Vertical" ]));
              default = "Horizontal";
              description = ''
        ...
        type = submodule {
          options = {
            ...
            "NavigationEndNotification" = mkOption {
              ...
              default =
                "Gwenview::SlideShow::NavigationEndNotification::WarnOnSlideshow";
              description = ''
  ...
  config =
    mkIf cfg.enable { programs.plasma.files."gwenviewrc" = cfg.gwenview; };
}
