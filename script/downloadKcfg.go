...
func main() {
	...
	//q=.kcfg+repo%3AKDE%2Fdolphin+language%3AXML+language%3AXML&type=Code&ref=advsearch&l=XML&l=XML
	//
	r, closer := download("https://api.github.com/search/code?q=.kcfg+repo%3AKDE%2Fdolphin+language%3AXML+language%3AXML&type=Code&ref=advsearch&l=XML&l=XML")
	defer closer()
