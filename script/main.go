...
func main() {
	...
	r, closer := download("https://api.github.com/search/code?q=filename%3A*.kcfg+user%3AKDE+language%3AXML+language%3AXML+language%3AXML+language%3AXML&type=Code&ref=advsearch&l=XML&l=XML")
	defer closer()
